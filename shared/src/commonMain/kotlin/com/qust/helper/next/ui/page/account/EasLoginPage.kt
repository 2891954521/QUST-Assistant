...
class EasLoginPage: AppPage<EasLoginViewModel>(
	title = "教务登陆",
	icon = Drawables.IconLogin,
	viewModelClass = EasLoginViewModel::class
) {
...
class EasLoginViewModel: BaseViewModel() {

	val account = mutableStateOf(AppSetting[DataKeys.EAS_ACCOUNT, ""])
	val password = mutableStateOf(AppSetting[DataKeys.EAS_PASSWORD, ""])
