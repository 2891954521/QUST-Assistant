...
import com.qust.base.ui.BaseFragmentAbleActivity;
import com.qust.base.ui.MenuAble;

public abstract class BaseFragment extends Fragment{
	
	protected BaseFragmentAbleActivity activity;
	...
	protected void initToolBar(){
		...
		if(toolbar != null){
			...
			if(isRoot && activity instanceof MenuAble){
	 ...
	 * 关闭这个Fragment
	 */
	public void finish(){ activity.closeFragment(); }
	...
	private onCreateAnimationListener animationListener;
	
	@Nullable
	@Override
	public Animation onCreateAnimation(int transit, boolean enter, int nextAnim){
		Animation anim = null;
		if(animationListener != null) anim = animationListener.onCreateAnimation(nextAnim);
		return anim != null ? anim : super.onCreateAnimation(transit, enter, nextAnim);
	}
	
	public void setAnimationListener(onCreateAnimationListener animationListener){
		this.animationListener = animationListener;
	}
	
	public interface onCreateAnimationListener{
		
		default Animation onCreateAnimation(int nextAnim){ return null; }
	}
}
